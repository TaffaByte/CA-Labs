`timescale 1ns / 1ps
// tb_top - Main project testbench (Part C: array summation)
//
// This testbench:
...
//       "Add Signals" from the tb_top scope.
...
// without you having to type 'run 25us'. Then expand 'tb_top' in the
...
module tb_top;
    ...
    //  shows up directly under tb_top in the Scope window.
    // =====================================================================
